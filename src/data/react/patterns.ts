...
function UserProfile({ id }) {
  ...
  },
  {
    ...
    answer: 'The slot pattern composes layouts by accepting multiple named props (header, sidebar, footer) instead of relying on a single children prop, giving callers explicit places to inject content. This avoids prop explosion where one component takes dozens of boolean flags like showHeader or showSidebar. Named slots make layout APIs self-documenting and flexible for different page structures.',
