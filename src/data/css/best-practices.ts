...
export const bestPracticesQuestions: InterviewQuestion[] = [
  {
    ...
    answer: 'BEM (Block, Element, Modifier) is a naming convention that structures CSS classes into three parts: Block (standalone component), Element (part of a block, separated by __), and Modifier (variant or state, separated by --). This creates predictable, self-documenting class names like .card__title--highlighted that avoid specificity wars and make HTML intent clear. Elements are never nested in the class name (avoid .card__header__title—use .card__title instead).',
    code: `.product-card { }
.product-card__image { }
.product-card__title { }
.product-card__price { }
