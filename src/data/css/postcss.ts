...
/* .grid {
  ...
  },
  {
    ...
    answer: 'Autoprefixer is a PostCSS plugin that automatically adds vendor prefixes (-webkit-, -moz-, -ms-) to CSS properties based on browser support data from Can I Use, driven by your Browserslist configuration. Instead of manually writing -webkit-transform alongside transform, you write the standard property once and Autoprefixer handles compatibility. It also removes outdated prefixes you no longer need as browser support improves.',
    code: `/* You write */
.card {
  display: flex;
