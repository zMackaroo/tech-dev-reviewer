...
export default function DashboardError({
  ...
  },
  {
    ...
    answer: 'not-found.tsx renders custom UI when a route segment cannot be found, and calling notFound() from next/navigation triggers it for that segment. Unlike error.tsx, it handles expected missing resources rather than unexpected exceptions. You can define not-found.tsx at different levels so a missing product shows a shop-specific 404 while unknown top-level paths use the root 404.',
