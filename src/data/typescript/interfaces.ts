...
createUser({ name: "Carol", email: "c@d.com" }); // excess check applies`,
  },
  {
    ...
    answer: 'A callable interface describes an object that can be invoked as a function by defining a call signature with (args): ReturnType syntax alongside regular properties. This pattern models functions that also carry metadata, such as a debounced function with a .cancel() method or a React component with static properties. Callable interfaces bridge the gap between function types and object types.',
